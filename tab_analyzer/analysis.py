...
CHORD_PATTERNS: tuple[tuple[str, str, tuple[int, ...]], ...] = (
    ...
    ("add11", "add11", (0, 4, 5, 7)),
    ("minor add11", "madd11", (0, 3, 5, 7)),
    ("major 7", "maj7", (0, 4, 7, 11)),
    ("dominant 7", "7", (0, 4, 7, 10)),
    ("minor 7", "m7", (0, 3, 7, 10)),
    ("minor major 7", "mMaj7", (0, 3, 7, 11)),
    ("half diminished", "m7b5", (0, 3, 6, 10)),
    ("diminished 7", "dim7", (0, 3, 6, 9)),
    ("diminished major 7", "dimMaj7", (0, 3, 6, 11)),
    ("augmented 7", "aug7", (0, 4, 8, 10)),
    ("augmented major 7", "maj7#5", (0, 4, 8, 11)),
    ("dominant 7 flat 5", "7b5", (0, 4, 6, 10)),
    ("dominant 7 sharp 5", "7#5", (0, 4, 8, 10)),
    ("suspended 7", "7sus4", (0, 5, 7, 10)),
    ("major 6", "6", (0, 4, 7, 9)),
    ("minor 6", "m6", (0, 3, 7, 9)),
    ("six nine", "6/9", (0, 2, 4, 7, 9)),
    ("minor six nine", "m6/9", (0, 2, 3, 7, 9)),
    ("dominant 9", "9", (0, 2, 4, 7, 10)),
    ("minor 9", "m9", (0, 2, 3, 7, 10)),
    ("major 9", "maj9", (0, 2, 4, 7, 11)),
    ("minor major 9", "mMaj9", (0, 2, 3, 7, 11)),
    ("suspended 9", "9sus4", (0, 2, 5, 7, 10)),
    ("dominant 11", "11", (0, 2, 4, 5, 7, 10)),
    ("minor 11", "m11", (0, 2, 3, 5, 7, 10)),
    ("major 11", "maj11", (0, 2, 4, 5, 7, 11)),
    ("dominant 13", "13", (0, 2, 4, 7, 9, 10)),
    ("minor 13", "m13", (0, 2, 3, 5, 7, 9, 10)),
    ("major 13", "maj13", (0, 2, 4, 7, 9, 11)),
    ("suspended 13", "13sus4", (0, 2, 5, 7, 9, 10)),
    ("dominant 7 flat 9", "7b9", (0, 1, 4, 7, 10)),
    ("dominant 7 sharp 9", "7#9", (0, 3, 4, 7, 10)),
    ("dominant 7 sharp 11", "7#11", (0, 4, 6, 7, 10)),
    ("dominant 7 flat 13", "7b13", (0, 4, 7, 8, 10)),
    ("dominant 9 sharp 11", "9#11", (0, 2, 4, 6, 7, 10)),
    ("dominant 13 flat 9", "13b9", (0, 1, 4, 7, 9, 10)),
    ("dominant 13 sharp 11", "13#11", (0, 2, 4, 6, 7, 9, 10)),
    ("dominant 7 flat 9 flat 13", "7b9b13", (0, 1, 4, 7, 8, 10)),
    ("dominant 7 sharp 9 flat 13", "7#9b13", (0, 3, 4, 7, 8, 10)),
    ("dominant 7 flat 5 flat 9", "7b5b9", (0, 1, 4, 6, 10)),
    ("dominant 7 sharp 5 flat 9", "7#5b9", (0, 1, 4, 8, 10)),
    ("dominant 7 sharp 5 sharp 9", "7#5#9", (0, 3, 4, 8, 10)),
    ("dominant 9 flat 5", "9b5", (0, 2, 4, 6, 10)),
    ("dominant 9 sharp 5", "9#5", (0, 2, 4, 8, 10)),
    ("dominant altered", "7alt", (0, 1, 3, 4, 6, 8, 10)),
    ("major 7 sharp 11", "maj7#11", (0, 4, 6, 7, 11)),
    ("major 9 sharp 11", "maj9#11", (0, 2, 4, 6, 7, 11)),
    ("minor 9 flat 5", "m9b5", (0, 2, 3, 6, 10)),
    ("minor 11 flat 5", "m11b5", (0, 2, 3, 5, 6, 10)),
    ("minor 7 add 11", "m7add11", (0, 3, 5, 7, 10)),
    ("minor 7 add 13", "m7add13", (0, 3, 7, 9, 10)),
    ("suspended 7 flat 9", "7sus4b9", (0, 1, 5, 7, 10)),
    ("suspended 7 flat 9 flat 13", "7sus4b9b13", (0, 1, 5, 7, 8, 10)),
    ("quartal", "quartal", (0, 5, 10)),
)
